  ...
  return (
    ...
    >
      {isSubmitting ? (
        ...
        <Tooltip
          content={
            <I18nText translationKey="posts.comments.form.submit.tooltip" />
          }
        >
          <span>
            <IoSend
...
function ResponseDisplayer() {
  ...
  return (
    <div className="flex w-full items-center justify-between">
      ...
      <Tooltip
        content={
          <I18nText translationKey="posts.comments.form.reply.remove.tooltip" />
        }
      >
  ...
  return (
    <>
      ...
      <button onClick={clickInput}>
        <Tooltip
          content={
            <I18nText translationKey="posts.comments.form.inputs.file.tooltip" />
          }
        >
          <span>
