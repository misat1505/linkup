      ...
      <div className="flex items-center gap-x-4">
        ...
        >
          {isSubmitting ? (
            ...
            <Tooltip
              content={<I18nText translationKey="chats.form.submit.tooltip" />}
            >
              <span>
                <IoSend
  ...
  return (
    <>
      ...
      <button onClick={clickInput}>
        <Tooltip
          content={<I18nText translationKey="chats.form.inputs.file.tooltip" />}
        >
          <span>
  ...
  return (
    <div className="flex w-full items-center justify-between gap-x-4 pb-4">
      ...
      <button onClick={() => setResponse(null)}>
        <Tooltip
          content={
            <I18nText translationKey="chats.form.reply.cancel.tooltip" />
          }
        >
          <span>
