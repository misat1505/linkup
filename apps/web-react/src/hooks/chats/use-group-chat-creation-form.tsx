...
import { newGroupChatFormSchema, NewGroupChatFormType } from "@/validators/chat.validators";
...
export type useNewGroupChatFormValue = {
	...
	submitForm: (e?: React.BaseSyntheticEvent<object, unknown, unknown> | undefined) => Promise<void>;
};
