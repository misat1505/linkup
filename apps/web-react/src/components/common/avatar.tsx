...
import { getStatus, Status, timeDifference } from "@packages/ui/utils/time-difference";
...
export default function Avatar({ src, alt, lastActive, className }: AvatarProps) {
	return (
		<div className="relative">
			<Image
				src={src}
				className={{
					common: cn("h-12 w-12 rounded-full bg-slate-200 dark:bg-slate-800", className),
					img: "object-cover",
