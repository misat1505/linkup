...
describe("handleMarkdownUpdate", () => {
    ...
    `;
		mockFileStorage.listFiles.mockResolvedValue(["posts/123/file1.png", "posts/123/file2.png"]);
		...
		expect(mockFileStorage.deleteFile).toHaveBeenCalledWith("posts/123/file2.png");
