...
function updateUrlsInContent(content: string, filesInfo: FileInfo[], postId: Post["id"]): string {
...
async function removeUnusedFiles(fileStorage: FileStorage, files: FileInfo[], postId: Post["id"]) {
