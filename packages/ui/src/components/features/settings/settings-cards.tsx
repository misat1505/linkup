	...
	const cards = [
		{
			...
			description: <TRANSLATION_COMPONENT translationKey="settings.language.description" />,
			switchComponent: <LanguageSwitch changeLanguage={changeLanguage} language={language} />,
		},
		{
			title: <TRANSLATION_COMPONENT translationKey="settings.theme.title" />,
			description: <TRANSLATION_COMPONENT translationKey="settings.theme.description" />,
		...
		},
		{
			...
			description: <TRANSLATION_COMPONENT translationKey="settings.tooltips.description" />,
