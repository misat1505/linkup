...
function NavigationItem({ chat, me }: NavigationItemProps) {
	...
	return (
		<Tooltip content={<TRANSLATION_COMPONENT translationKey="chats.navigation.items.tooltip" />}>
			<span>
				<LINK_COMPONENT
				...
				>
					...
					<div className="overflow-hidden text-left">
						<div className="overflow-hidden text-nowrap font-semibold">{chatName}</div>
						<div className="overflow-hidden text-nowrap text-sm">
							<LastMessageDisplayer chat={chat} lastMessage={chat.lastMessage} me={me} />
						</div>
					</div>
				</LINK_COMPONENT>
			</span>
