...
export function ChatLeaveDialog({ chatId, leaveChatAction, leaveChatCb }: ChatLeaveDialogProps) {
	...
	return (
		<AlertDialog open={isOpen}>
			<Tooltip content={<TRANSLATION_COMPONENT translationKey="chats.leave.trigger.tooltip" />}>
