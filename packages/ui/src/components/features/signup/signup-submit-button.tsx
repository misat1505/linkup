...
export function SignupSubmitButton({ type, isSubmitting }: SignupSubmitButtonProps) {
	const loadingText =
		type === "create" ? (
	...
	return (
		<div className="mt-8 flex justify-center">
			<Button type="submit" disabled={isSubmitting} data-testid="cy-signup-form-button">
				{isSubmitting ? (
