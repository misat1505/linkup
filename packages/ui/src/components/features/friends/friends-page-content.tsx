...
export function FriendsPageContent({ friendships, me, ...actions }: FriendsPageContentProps) {
	...
	const columns: ColumnDef<Friendship>[] = [
		{
			cell: ({ row }) => {
				...
				const otherUser =
					friendship.requester.id === me!.id ? friendship.acceptor : friendship.requester;
