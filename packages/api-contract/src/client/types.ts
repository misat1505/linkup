...
type ExtractRequestBody<K extends keyof typeof API_CONTRACT> = (typeof API_CONTRACT)[K] extends {
...
> = ExtractSchema<K, S> extends z.ZodTypeAny ? z.infer<ExtractSchema<K, S>> : never;
...
type ExtractRequestParams<K extends keyof typeof API_CONTRACT> = (typeof API_CONTRACT)[K] extends {
	request: { params: infer S };
}
	? S extends z.ZodTypeAny
		? z.infer<S>
		: never
...
type ExtractRequestQuery<K extends keyof typeof API_CONTRACT> = (typeof API_CONTRACT)[K] extends {
