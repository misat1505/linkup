...
export class ApiContractClient {
  ...
  // chats
  addUserToGroupChat(
    args: ClientBody<typeof CONTRACT_KEYS.ADD_USER_TO_GROUP_CHAT>,
  ) {
    return this.request(
      CONTRACT_KEYS.ADD_USER_TO_GROUP_CHAT,
      StatusCodes.CREATED,
      args,
    );
  }
  createGroupChat(args: ClientBody<typeof CONTRACT_KEYS.CREATE_GROUP_CHAT>) {
    return this.request(
      CONTRACT_KEYS.CREATE_GROUP_CHAT,
      StatusCodes.CREATED,
      args,
      true,
    );
  ...
  createPrivateChat(
    args: ClientBody<typeof CONTRACT_KEYS.CREATE_PRIVATE_CHAT>,
  ) {
    return this.request(
      CONTRACT_KEYS.CREATE_PRIVATE_CHAT,
      StatusCodes.CREATED,
      args,
    );
  }
  createReaction(args: ClientBody<typeof CONTRACT_KEYS.CREATE_REACTION>) {
    return this.request(
      CONTRACT_KEYS.CREATE_REACTION,
      StatusCodes.CREATED,
      args,
    );
  }
  deleteSelfFromGroupChat(
    args: ClientBody<typeof CONTRACT_KEYS.DELETE_SELF_FROM_GROUP_CHAT>,
  ) {
    return this.request(
      CONTRACT_KEYS.DELETE_SELF_FROM_GROUP_CHAT,
      StatusCodes.OK,
      args,
    );
  }
  ...
  updateGroupChat(args: ClientBody<typeof CONTRACT_KEYS.UPDATE_GROUP_CHAT>) {
    return this.request(
      CONTRACT_KEYS.UPDATE_GROUP_CHAT,
      StatusCodes.OK,
      args,
      true,
    );
  ...
  createFriendship(args: ClientBody<typeof CONTRACT_KEYS.CREATE_FRIENDSHIP>) {
    return this.request(
      CONTRACT_KEYS.CREATE_FRIENDSHIP,
      StatusCodes.CREATED,
      args,
    );
  }
